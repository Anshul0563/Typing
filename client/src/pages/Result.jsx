...
function HighlightedText({ parts, emptyLabel, highlightSeverity }) {
  ...
  return <p className="comparison-text">{parts.map((part, index) => {
    return part.severity === highlightSeverity
