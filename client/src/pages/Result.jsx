...
function HighlightedText({ parts, emptyLabel, highlightSeverity }) {
  if (!parts?.length) return <p className="comparison-empty">{emptyLabel}</p>;
  return <p className="comparison-text">{parts.map((part, index) => part.severity === 'correct' || part.severity !== highlightSeverity
