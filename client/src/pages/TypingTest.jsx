...
export default function TypingTest() {
  ...
  const inputRef = useRef(null); const referenceRef = useRef(null); const currentWordRef = useRef(null); const audioContextRef = useRef(null); const submittingRef = useRef(false); const activeRef = useRef(false); const typedRef = useRef(''); const endAtRef = useRef(0); const monotonicEndRef = useRef(0); const testTokenRef = useRef(''); const keystrokesRef = useRef(0); const backspacesRef = useRef(0); const selectedModeRef = useRef('Custom');
